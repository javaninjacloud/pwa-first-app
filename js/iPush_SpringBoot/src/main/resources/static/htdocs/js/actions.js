$(document).ready(function(){
    ...
    $(".user-change-button").click(function(){       
       $(this).parents(".block").find('.user-change').animate({opacity: 0},400,function(){
           $(this).find('img').attr('src','htdocs/img/user.jpg');
...
function lists(){    
    $(".list").each(function(){        
        ...
        if(items.length > 0)            
            items.each(function(){
                $(this).height($(this).parent().parent().parent('.list-item').height()-10).css('line-height',$(this).parent().parent().parent('.list-item').height()-10+'px');
            });                            
    });    
}
...
function login(){
	...
	if(profile==="offshore"){
		$("#userPic").attr('src','htdocs/img/logo/iron_man.png');
	}else{
		$("#userPic").attr('src','htdocs/img/logo/iron_man.png');
	}
